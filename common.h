...
#define TYPE_FAMILY_FIGURE	2168// TYPE_FIGURE + TYPE_PERIOD + TYPE_COMMA + TYPE_MIDDLE_DOT + TYPE_KANJI_FIGURE  8+16+64+32+2048 
#define TYPE_FAMILY_PUNC	114 // TYPE_PERIOD + TYPE_COMMA + TYPE_IDEOGRAPHIC_PUNC + TYPE_MIDDLE_DOT

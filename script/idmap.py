...
class IdMap(object):
    ...
    def parse_grammar(self, text):
        ...
        [(('特殊', '*'), 0), (('特殊', '句点'), 1), (('特殊', '括弧始'), 3), (('特殊', '括弧終'), 4), (('特殊', '空白'), 6), (('特殊', '記号'), 5), (('特殊', '読点'), 2)]
        ...
        [('動詞', 2), ('名詞', 3), ('特殊', 1)]
        >>> print(sorted(t.pos_spos2id.items()))
        [(('動詞', '*'), 0), (('名詞', '*'), 0), (('名詞', 'サ変名詞'), 2), (('名詞', '人名'), 5), (('名詞', '副詞的名詞'), 9), (('名詞', '固有名詞'), 3), (('名詞', '地名'), 4), (('名詞', '形式名詞'), 8), (('名詞', '数詞'), 7), (('名詞', '時相名詞'), 10), (('名詞', '普通名詞'), 1), (('名詞', '組織名'), 6), (('特殊', '*'), 0), (('特殊', '句点'), 1), (('特殊', '括弧始'), 3), (('特殊', '括弧終'), 4), (('特殊', '空白'), 6), (('特殊', '記号'), 5), (('特殊', '読点'), 2)]
        
        >>> t.parse_grammar("((形容詞 %))\\n\\n((判定詞 %))")
        >>> print(sorted(t.pos2id.items()))
        [('判定詞', 5), ('動詞', 2), ('名詞', 3), ('形容詞', 4), ('特殊', 1)]
        ...
        for s_exp in self.sp.parse(text):
            pos = s_exp[0][0]
            self.pos2id[pos] = len(self.pos2id) + 1
            spos_id = 1
            if len(s_exp) > 1:
    ...
    def parse_katuyou(self, text):
        ...
        [(('母音動詞', '*'), 0), (('母音動詞', 'タ形'), 10), (('母音動詞', 'タ接連用形'), 9), (('母音動詞', 'タ系推量形'), 11), (('母音動詞', 'タ系条件形'), 13), (('母音動詞', 'タ系省略推量形'), 12), (('母音動詞', 'タ系連用タリ形'), 15), (('母音動詞', 'タ系連用チャ形'), 16), (('母音動詞', 'タ系連用テ形'), 14), (('母音動詞', '命令形'), 6), (('母音動詞', '基本形'), 2), (('母音動詞', '基本条件形'), 7), (('母音動詞', '基本連用形'), 8), (('母音動詞', '意志形'), 4), (('母音動詞', '文語命令形'), 18), (('母音動詞', '未然形'), 3), (('母音動詞', '省略意志形'), 5), (('母音動詞', '語幹'), 1), (('母音動詞', '音便条件形'), 17)]
        ...
        for s_exp in self.sp.parse(text):
            conj_type = s_exp[0]
            self.type2id[conj_type] = len(self.type2id) + 1
            conj_id = 1
            if len(s_exp) > 1:
